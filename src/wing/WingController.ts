  ...
  try {
    ...
    if (existingWing) {
      logAction(
        ...
        "Wing with that name already exists. Cannot duplicate."
      );
    ...
    if (!wing) {
      logAction(
        ...
        "registerWing",
        "database",
        "WingID not available",
        "Wing creation failed."
      );
      return res
        .status(400)
  ...
  try {
    ...
    if (!currentWing) {
      logAction(
        ...
        "validation",
        `WingID: ${id}`,
        "Could not find Wing. Edit failed."
      );
  ...
  try {
    ...
    if (!deletedWing) {
      logAction(
        ...
        "validation",
        `WingID: ${id}`,
        "Wing not found or already deleted."
      );
